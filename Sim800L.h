...
typedef SoftwareSerial Sim800LSerial;
#define DEFAULT_RX_PIN 10
#define DEFAULT_TX_PIN 11
#else
typedef HardwareSerial Sim800LSerial;
...
class Sim800L : public Sim800LSerial
{
private:
    uint32_t _baud;
    int _timeout;
...
#else
    Sim800L(uint8_t uartnumber);
    Sim800L(uint8_t uartnumber, uint8_t rst);
    Sim800L(uint8_t uartnumber, uint8_t rst, uint8_t led);
#endif
